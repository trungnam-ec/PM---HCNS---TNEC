...
- CHỈ trích xuất các mặt hàng thực sự là Văn phòng phẩm, nhu yếu phẩm văn phòng (ví dụ: bút, giấy, bìa, mực, ghim, kẹp, nước suối...).
- BỎ QUA các hàng tổng cộng, tiêu đề, ghi chú, hướng dẫn, dữ liệu rác, nhân sự, máy móc thiết bị, hoặc các mặt hàng không thuộc nhóm VPP.
- BỎ QUA các vật tư có số lượng (qty) yêu cầu bằng 0, để trống, hoặc không xác định.
...
CHÚ Ý ĐẶC BIỆT: Nếu trong file có chứa danh mục vật tư dài (ví dụ 70-100 món để làm dropdown chọn lựa), TUYỆT ĐỐI KHÔNG trích xuất các món đó. CHỈ trích xuất đúng các mặt hàng được người dùng điền số lượng yêu cầu cụ thể (>0).`;
